...
export default function FeaturedPosts() {
  ...
  if (posts.length === 0) {
    return (
      <div className="my-12">
        <h2 className="text-2xl font-bold mb-6">Featured Posts</h2>
        <p className="text-center text-muted-foreground py-8">No posts found for this category. Check back later!</p>
      </div>
    )
  }
  ...
  return (
    <div className="my-12">
      <h2 className="text-2xl font-bold mb-6">
        Featured Posts {categoryParam && `in ${categoryParam.charAt(0).toUpperCase() + categoryParam.slice(1)}`}
      </h2>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {posts.map((post) => (
